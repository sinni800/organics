...
!1,Organics.WebSocketSupported&&this.__webSocket.close())};this.Connection.prototype.Connect=function(){var a=this;Organics.WebSocketSupported?a.__logMessage("WebSocket is supported"):a.__logMessage("No WebSocket support; using long polling");a.__connected||a.__connecting||(a.__logMessage("-> Connect()"),a.__connecting=!0,Organics.WebSocketSupported?a.__connectWebSocket():Organics.__ajax(a.__HTTP_URL,"POST",{complete:function(c){a.__connectionId=c.responseText;a.__logMessage("-> Create session request successful: connected to server");
a.__connected=!0;a.__connecting=!1;setTimeout(function(){a.__doLongPolling()},0);a.__handleConnect()},error:function(c,e){a.__handleDisconnect("Create session request failed ("+e+")")}},null,a.Timeout,{"X-Organics-Req":Organics.__rtLongPollEstablishConnection}))};this.Connection.prototype.__handleMessage=function(a){if(0<a.length){try{var c=JSON.parse(a)}catch(e){this.__handleDisconnect("Server sent bad JSON data: "+e);Organics.webSocketSupported&&this.__webSocket.close();return}if(3==c.length){a=
c[0];var b=c[1],c=c[2],f=null,k=this.__handlers[b];if(k){try{f=k.apply(void 0,c),null==f&&(f=[])}catch(d){Organics.__Log("Request handler exception:\n"+d);return}if(-1!==a)try{return JSON.stringify([a,f])}catch(h){Organics.__Log("Error encoding response:\n"+h)}}else Organics.__Log('Ignoring request "'+b+'", no handler.')}else if(2==c.length||1==c.length)if(a=c[0],c=1==c.length?[]:c[1],a=this.__requestHandlers[a])try{a.apply(void 0,c)}catch(s){Organics.__Log("Request handler onComplete exception:\n"+
s)}else Organics.__Log("Got invalid response; id is invalid; ignored.");else this.__handleDisconnect("Server sent bad JSON data: Must be array of length 3"),Organics.webSocketSupported&&this.__webSocket.close()}else if(Organics.WebSocketSupported)return""};this.Connection.prototype.__connectWebSocket=function(){var a=this;window.WebSocket?a.__webSocket=new WebSocket(a.__URL):window.MozWebSocket&&(a.__webSocket=new MozWebSocket(a.__URL));a.__webSocket.onopen=function(c){a.__connected=!0;a.__connecting=
!1;a.__handleConnect()};a.__webSocket.onclose=function(c){a.__handleDisconnect("connection closed")};a.__webSocket.onmessage=function(c){c=a.__handleMessage(c.data);null!=c&&a.__webSocket.send(c)};a.__webSocket.onerror=function(c){a.__handleDisconnect("disconnected"+c)}};this.Connection.prototype.__doLongPolling=function(){var a=this;Organics.__ajax(a.__HTTP_URL,"POST",{complete:function(c){c=a.__handleMessage(c.responseText);null!=c&&Organics.__ajax(a.__HTTP_URL,"POST",{complete:function(a){},error:function(c,
b){a.__handleDisconnect("POST request failed ("+b+")",0)}},c,null,{"X-Organics-Req":Organics.__rtMessage,"X-Organics-Conn":a.__connectionId});setTimeout(function(){a.__doLongPolling()},0)},error:function(c,e){a.__handleDisconnect("long-polling request failed ("+e+")",0)}},null,null,{"X-Organics-Req":Organics.__rtLongPoll,"X-Organics-Conn":a.__connectionId})};this.Connection.prototype.Request=function(){var a=this,c=Array.prototype.slice.call(arguments);if(0!=c.length){var e=c[0];if(1<c.length){var b=
c[c.length-1];"function"!=typeof b&&(b=null)}else b=null;c=null!=b?c.slice(1,c.length-1):c.slice(1,c.length);if(!a.Connected())throw a.__logMessage("-> Ignoring Request() call (Not connected)"),Organics.ErrNotConnected;a.__requestCounter++;-1==a.__requestCounter&&a.__requestCounter++;var f=a.__requestCounter;b?a.__requestHandlers[a.__requestCounter]=b:f=-1;e=JSON.stringify([f,e,c]);Organics.WebSocketSupported?a.__webSocket.send(e):Organics.__ajax(a.__HTTP_URL,"POST",{complete:function(a){},error:function(b,
c){b&&413==b.status?a.__handleDisconnect("JSON request data exceeded server's MaxBufferSize property.",0):a.__handleDisconnect("Request failed: "+c)}},e,a.Timeout,{"X-Organics-Req":Organics.__rtMessage,"X-Organics-Conn":a.__connectionId})}};this.Connection.prototype.Handle=function(a,c){if(null===c)delete this.__handlers[a];else{if("function"!==typeof c)throw TypeError('Handle() parameter "handler" must be function!');this.__handlers[a]=c}}};
